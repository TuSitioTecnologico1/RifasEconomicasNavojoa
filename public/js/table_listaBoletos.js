...
function generateTable(data) {
    const tableContainer = document.getElementById("table-listaBoletos-panel");

    // Crea la tabla
    const table = document.createElement("table");
    table.classList.add("tabla_boletos_superPanel");

    // Título de la tabla
    const caption = document.createElement("caption");
    caption.textContent = "Boletos";
...
document.getElementById("filtroTablaBoletos").addEventListener("input", function () {
    const filtro = this.value.toLowerCase();
    const filas = document.querySelectorAll(".tabla_boletos_superPanel tbody tr");
